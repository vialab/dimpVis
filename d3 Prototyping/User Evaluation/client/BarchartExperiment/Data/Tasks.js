...
var tasks = [
    [
        ...
        [1,0,11,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[1],6],
        [2,0,12,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[0],5],
        [1,0,31,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[5],8],
        ...
        [4,0,69,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,1,[1],7],
        ...
        [5,0,81,0,"When is A shorter than B?",1,0,[10,8],7],
        [5,0,82,0,"When is A equal to B?",1,0,[3,8],8],
        [5,0,83,0,"When is A taller than B?",1,0,[5,7],4],
        [5,0,84,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[1],4],
        [5,0,85,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[5],4],
        [5,0,86,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[2],5],
    ...
    [
        ...
        [0,1,30,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[1],6],
        [2,1,33,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[3],5],
        [2,1,32,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[0],8],
       /** [3,1,35,1,"When do the heights of A <span style='font-weight:bold'>AND</span> B change from increasing to decreasing?",1,0,[5,0],7],
        ...
        [4,1,72,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,1,[6],7],
        [4,1,73,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,1,[3],7],
        [4,1,74,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,1,[10],9],

        //Practice
        [5,1,90,0,"When is A greater than 140?",0,0,[0],8],
        [5,1,91,0,"When is A at 60?",0,0,[8],3],
        [5,1,92,0,"When is A less than 80?",0,0,[10],4],
        [5,1,93,0,"When is A equal to B?",1,0,[0,8],9],
        [5,1,94,0,"When is A shorter than B?",1,0,[7,10],4],
        [5,1,95,0,"When is A taller than B?",1,0,[5,2],4],
        [5,1,96,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[1],7],
        [5,1,97,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[4],8],
        [5,1,98,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[0],4]
    ...
    [
        ...
        [1,2,52,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[0],6],
        [2,2,53,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[10],5],
        [1,2,34,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[12],8],
       /** [3,2,56,1,"When do the heights of A <span style='font-weight:bold'>AND</span> B change from decreasing to increasing?",1,0,[1,4],8],
        ...
        [4,2,75,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,1,[3],9],
        [4,2,77,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,1,[9],7],
        [4,2,71,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,1,[8],7],

        //Practice
        [5,2,102,0,"When is A at 120?",0,0,[0],6],
        [5,2,103,0,"When is A greater than 120?",0,0,[8],9],
        [5,2,104,0,"When is A less than 60?",0,0,[3],3],
        [5,2,105,0,"When is A equal to B?",1,0,[8,10],9],
        [5,2,106,0,"When is A shorter than B?",1,0,[7,3],4],
        [5,2,107,0,"When is A taller than B?",1,0,[5,10],4],
        [5,2,108,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[2],8],
        [5,2,109,1,"After the height of A has been increasing, find the first year when it is decreasing.",0,0,[6],5],
        [5,2,110,1,"After the height of A has been decreasing, find the first year when it is increasing.",0,0,[8],6]
