...
var tasks = [
    [
        ...
        [0,0,3,0,"When is the orange bar greater than 160?",0,0,[6],6],
        ...
        [1,0,6,0,"When is the orange bar taller than the green bar?",1,0,[2,6],8],
        ...
        [4,0,63,0,"When is the orange bar at 120?",0,1,[2],6],
        [4,0,60,0,"When is the orange bar greater than 160?",0,1,[0],9],
        ...
        [4,0,76,1,"When does the height of the orange bar change from increasing to decreasing?",0,1,[11],8],
    ...
    [
        ...
        [4,1,61,0,"When is the orange bar at 140?",0,1,[7],4],
        ...
        [4,1,74,1,"When does the height of the orange bar change from decreasing to increasing?",0,1,[10],8],

        //Practice
        [5,1,90,0,"When is the orange bar greater than 140?",0,0,[0],8],
    ...
    [
        //Objective
        [2,2,24,0,"When is the orange bar at 160?",0,0,[7],5],
        [1,2,42,0,"When is the orange bar greater than 100?",0,0,[11],5],
        [2,2,44,0,"When is the orange bar less than 80?",0,0,[4],6],
        [0,2,48,0,"When is the orange bar taller than the green bar?",1,0,[4,11],9],
        [0,2,47,0,"When is the orange bar equal to the green bar?",1,0,[3,0],8],
        ...
        [4,2,75,1,"When does the height of the orange bar change from decreasing to increasing?",0,1,[3],8],
        [4,2,77,1,"When does the height of the orange bar change from increasing to decreasing?",0,1,[9],6],
        [4,2,71,1,"When does the height of the orange bar change from increasing to decreasing?",0,1,[8],6],

        //Practice
        [5,2,102,0,"When is the orange bar at 120?",0,0,[0],6],
