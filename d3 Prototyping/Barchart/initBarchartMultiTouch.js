...
/**barchart.touchEndFunction = function (){
    alert("touched end");
};
barchart.touchStartFunction = function () {
    alert("touched start");
}
barchart.touchMoveFunction = function () {
    alert("touched move");
}*/
...
barchart.dragEvent = d3.behavior.drag()
    ...
    .on("drag", function(d){
        ...
        barchart.updateDraggedBar(d.id,event.x,d3.event.y);
    })
